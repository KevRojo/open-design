...
export const zhCN: Dict = {
  ...
  'fileViewer.shareGuide.preferenceSaveFailed': "偏好保存失败，请重试。",
  "common.close": "关闭",
  "common.clear": "清除",
  "common.delete": "删除",
  "common.rename": "重命名",
  ...
  "designs.deleteConfirm": "删除「{name}」？",
  'designs.deleteActiveShares': "项目里有 {count} 个页面正在分享，删除后分享链接将失效，访问者无法再打开。",
  'designs.deletedShareTitle': "原文件已删除",
  'designs.deletedShareRetrying': "链接正在停用,稍后将无法访问",
  'designs.deletedShareFailed': "链接停用失败,可能仍可访问",
  'designs.deletedShareRetry': "重试停用",
